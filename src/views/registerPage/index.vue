<template>
    <div class="mainBody">
        <el-row class="container">
            <el-col :lg="2" :md="2" :sm="2" :xs="2"></el-col>
            <el-col class="textBox" :lg="8" :md="6" :sm="6" :xs="0">
                <el-button type="primary" @click="toSginIn">Sign In</el-button><span
                    class="text-4xl font-mono font-600 text-light-300">Welcome to Meher Admin Ui Kit!</span><span
                    class="text-xl font-medium text-light-300">To keep connected with us please login with your personal
                    info.</span>
            </el-col>
            <el-col class="formBox" :lg="12" :md="14" :sm="14" :xs="20">
                <div class="logo"><span><svg xmlns="http://www.w3.org/2000/svg"
                            xmlns:xlink="http://www.w3.org/1999/xlink" fill="none" version="1.1" width="4vh"
                            height="4vh" viewBox="0 0 46 25">
                            <defs>
                                <linearGradient id="master_svg0_5_40242" x1="0" y1="0" x2="1.0199999809265137"
                                    y2="1.0099999904632568">
                                    <stop offset="0%" stop-color="#FF3D57" stop-opacity="1"></stop>
                                    <stop offset="100%" stop-color="#FF8A48" stop-opacity="1"></stop>
                                </linearGradient>
                            </defs>
                            <g style="mix-blend-mode:passthrough">
                                <path
                                    ...
                                    fill-rule="evenodd" fill="url(#master_svg0_5_40242)" fill-opacity="1"></path>
                            </g>
                        </svg></span><span>meher</span></div>
                <div class="loginBox"><span class="title">Create Account</span>
                    <div class="option"><svg xmlns="http://www.w3.org/2000/svg"
                            xmlns:xlink="http://www.w3.org/1999/xlink" fill="none" version="1.1" width="41" height="41"
                            viewBox="0 0 41 41">
                            <g style="mix-blend-mode:passthrough">
                                <g style="opacity:0.25;mix-blend-mode:passthrough">
                                    <path
                                        ...
                                        fill="#8291A9" fill-opacity="1"></path>
                                </g>
                                <g style="mix-blend-mode:passthrough">
                                    <path
                                        ...
                                        fill-rule="evenodd" fill="#0081FF" fill-opacity="1"></path>
                                </g>
                            </g>
                        </svg><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                            fill="none" version="1.1" width="41" height="41" viewBox="0 0 41 41">
                            <g style="mix-blend-mode:passthrough">
                                <g style="opacity:0.25;mix-blend-mode:passthrough">
                                    <path
                                        d="M34.5,41L6.5,41Q3.80761,41,1.90381,39.0962Q0,37.1924,0,34.5L0,6.5Q0,3.80761,1.90381,1.90381Q3.80761,0,6.5,0L34.5,0Q37.1924,0,39.0962,1.90381Q41,3.80761,41,6.5L41,34.5Q41,37.1924,39.0962,39.0962Q37.1924,41,34.5,41ZM34.5,40Q36.7782,40,38.3891,38.3891Q40,36.7782,40,34.5L40,6.5Q40,4.22182,38.3891,2.61091Q36.7782,1,34.5,1L6.5,1Q4.221830000000001,1,2.61091,2.61091Q1,4.22182,1,6.5L1,34.5Q1,36.7782,2.61091,38.3891Q4.22182,40,6.5,40L34.5,40Z"
                        ...
                        </svg></div><span class="font-mono tracking-widest text-lg font-semibold text-gray-500">or use
                        your email for regitration</span>
                    <div class="input">
                        <el-form :model="userInfo" ref="ruleFormRef" :rules="rules">
                            ...
                            <el-form-item prop="password">
                                <el-input v-model="userInfo.password" type="password" placeholder="password"
                                    show-password @keyup.enter="submitForm(ruleFormRef)"></el-input>
                            </el-form-item>
                            <el-form-item>
                                <el-button type="primary" @click="submitForm(ruleFormRef)" :loading="submitLoading">Sign
                                    up</el-button>
                            </el-form-item>
                        </el-form>
                    </div>
            ...
            if (value === '') {
                ...
                if (userInfo.password !== '') {
                    if (!ruleFormRef.value) {
                        return ruleFormRef.value.validateField('name', () => null)
                    }
                }
                callback()
            }
